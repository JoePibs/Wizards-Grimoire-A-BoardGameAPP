...
interface Entity {
  ...
  const Card = ({ name, short_description, image, editors, illustrators, themes, mechanics, min_age, min_player, max_player, id }: CardData) => {
    return (
      <Link href={`/game/${id}`} className="block">
        <div className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
          ...
          <div className="flex items-center px-6 py-3 bg-gray-900">
            ...
            <h1 className="mx-3 text-lg font-semibold text-white">{name} et id = {id}</h1>
